<script>
	...
	import { externalStuff } from '$lib/stores/playground.js';
	...
	import SideComponent from '$components/features/playground/editorSets/sideComponent.svelte';
...
<button
	...
	class="flex cursor-pointer items-center gap-2 rounded-xl bg-gradient-to-r from-sky-400 to-sky-300 p-2 text-sm text-black transition-all duration-300 hover:bg-gradient-to-bl hover:opacity-80"
...
{#if modal}
	...
	>
		<div
			class="sticky top-0 z-50 mb-6 flex w-full items-center justify-center border-b border-sky-300 bg-white pb-2 pt-4 text-black dark:bg-primary dark:text-white"
		>
			<!-- <div
