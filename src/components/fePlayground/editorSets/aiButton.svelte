<script>
	...
	import { aibox } from '$lib/feEditor/aiFunctions.js';
...
<button on:click={handleClick} class="px-2 py-2 flex items-center justify-center bg-gradient-to-r from-sky-400 to-sky-300  rounded-full">
	<svg
